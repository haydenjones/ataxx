...
public class ApplyMove_Test {
	@Test
	public void works() {
		List<AnimateInfo> animations = new ArrayList<>();
		...
		AtaxxChangeInfo actual = GameEngine.applyMove(state, move, animations);

		Assertions.assertTrue(animations.size() == 2, "Wrong number of animations.");
		Assertions.assertSame(ChangeType.GAME_MOVE, actual.type());
...
//
//		System.out.println("");
//		System.out.println("AtaxxChangeInfo");
